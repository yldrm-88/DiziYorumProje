    ...
    public partial class BlogGuncelle : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsPostBack == false)
            {
                ...
                TextBox2.Text = deger.BLOGBASLIK;
                TextBox1.Text = deger.BLOGTARIH.ToString();
                TextBox3.Text = deger.BLOGGORSEL;
                TextBox4.Text = deger.BLOGICERİK;
                DropDownList1.SelectedValue=deger.BLOGTUR.ToString();
                DropDownList2.SelectedValue=deger.BLOGKARAKTERI.ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            blog.BLOGBASLIK = TextBox2.Text;
            blog.BLOGTARIH = DateTime.Parse(TextBox1.Text);
            blog.BLOGGORSEL= TextBox3.Text;
            blog.BLOGICERİK= TextBox4.Text;
            blog.BLOGTUR = byte.Parse(DropDownList1.SelectedValue);
            blog.BLOGKARAKTERI = byte.Parse(DropDownList2.SelectedValue);
            db.SaveChanges();
